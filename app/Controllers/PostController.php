...
class PostController extends BaseAdminController
{
    ...
    private function getMessageWithPreviewUrl($post, $action = 'add')
    {
        ...
        $postSlug = $this->config->post_url_structure == 'id' ? $post->id : $post->slug;

        $postUrl = !isPostPublished($post) ? $baseUrl . 'post/preview/' . $postSlug : $baseUrl . $postSlug;
