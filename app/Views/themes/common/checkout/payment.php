        ...
        <main class="container pb-5">
            <div class="row g-lg-5">
                ...
                <div class="col-lg-7">
                    ...
                    <?php else: ?>
                        <div class="checkout-card mb-4">
                            ...
                            <?php if ($gateway->name_key === 'bank_transfer'): ?>
                                <div class="payment-method-wrapper mt-5 mb-4">
                                    <div class="mb-3">
                                        <strong><?= trans("bank_accounts"); ?></strong>
                                        <p class="text-muted vr-fs-md"><?= trans("bank_accounts_exp"); ?></p>
                                    </div>
                                    <div class="position-relative p-4 rounded-3 bg-body-tertiary shadow-sm">
                                        <div class="text-break position-relative z-1 editor-content" style="line-height: 1.8;">
                    ...
                    <?php if (in_array($gateway->name_key, ['stripe', 'razorpay', 'paystack', 'paytabs', 'nowpayments'])): ?>
