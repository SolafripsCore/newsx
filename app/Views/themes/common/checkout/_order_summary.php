<div class="checkout-card summary-card">
    ...
    elseif ($gateway->name_key === 'paystack'):
        echo loadCommonView("checkout/payment/_paystack");
    elseif ($gateway->name_key === 'paytabs'):
        echo loadCommonView("checkout/payment/_paytabs");
    elseif ($gateway->name_key === 'nowpayments'):
        echo loadCommonView("checkout/payment/_nowpayments");
    elseif ($gateway->name_key === 'bank_transfer'):
        echo loadCommonView("checkout/payment/_bank_transfer");
    endif; ?>
