...
<a href="<?= generateURL('account_settings'); ?>" class="action-item">
<div class="action-icon-box">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<?php endif; ?> <?php if ($premiumMembership->subscriptionStatus && $premiumMembership->subscriptionButtonVisibility && !hasPremiumAccess()): ?>
<div class="d-flex mt-3 mb-2 px-3">
<a href="<?= generateURL("subscription", "plans"); ?>" class="btn-nav-subscribe btn-nav-subscribe-mobile w-100 text-center" title="<?= trans("btn_subscribe"); ?>" aria-label="<?= trans("btn_subscribe"); ?>" rel="bookmark">
<?= trans("btn_subscribe"); ?>
</a>
</div>
<?php endif; ?>
