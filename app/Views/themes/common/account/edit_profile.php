            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-9">
                    ...
                    <form action="<?= base_url('account-settings-post'); ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div id="edit_profile_cover" class="edit-profile-cover edit-cover-no-image mb-5 rounded" style="<?= !empty($user->cover_image) ? "background-image: url('" . getStorageFileUrl($user->cover_image, $user->storage_cover) . "');" : ''; ?>">
                        ...
                        <div class="row g-4 form-section-gap">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username" class="form-control form-input" value="<?= esc($user->username); ?>" placeholder="<?= trans("username", "attr"); ?>" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label"><?= trans("slug"); ?></label>
                                <input type="text" name="slug" class="form-control form-input" value="<?= esc($user->slug); ?>" placeholder="<?= trans("slug", "attr"); ?>" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" name="email" class="form-control form-input" value="<?= esc($user->email); ?>" placeholder="<?= trans("email", "attr"); ?>" required>
                            ...
                            <div class="col-md-6">
                                <label class="form-label"><?= trans("first_name"); ?></label>
                                <input type="text" name="first_name" class="form-control form-input" value="<?= esc($user->first_name); ?>" placeholder="<?= trans("first_name", "attr"); ?>">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label"><?= trans("last_name"); ?></label>
                                <input type="text" name="last_name" class="form-control form-input" value="<?= esc($user->last_name); ?>" placeholder="<?= trans("last_name", "attr"); ?>">
                            </div>

                            <div class="col-12">
                                <label class="form-label"><?= trans("about_me"); ?></label>
                                <textarea name="about_me" class="form-control form-input form-textarea" rows="4" placeholder="<?= trans("about_me", "attr"); ?>"><?= esc($user->about_me); ?></textarea>
                            </div>
                        </div>
