...
<?= $this->endSection(); ?>
    ...
    <div class="d-flex mb-4">
        <div class="quiz-container <?php echo ($post->post_format == 'poll') ? 'poll-mode' : ''; ?>"
            ...
            <?php
            $paywallType = !empty($premiumMembership->paywallType) ? $premiumMembership->paywallType : 'preview';
            ...
            if (!empty($quizQuestions)):
                foreach ($quizQuestions as $question):
                    ...
                    <div id="quiz_question_<?= $question->id; ?>"
                        ...
                        <?php if ($hasAccess): ?>
                            <div class="quiz-body">
                                <?php $questionAnswers = !empty($quizAnswers[$question->id]) ? $quizAnswers[$question->id] : [];
