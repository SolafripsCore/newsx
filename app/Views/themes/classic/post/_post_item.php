...
?>
<div class="post-item<?= esc($extraClass); ?>">
    ...
    <?php if ($hasImage): ?>
        <div class="image ratio">
            <a href="<?= $postUrl; ?>" aria-label="<?= esc($postItem->title); ?>"<?= postUrlNewTab($postItem); ?>>
                <img src="<?= $imgUrl; ?>" alt="<?= esc($imgAltText); ?>" class="img-fluid" width="416" height="248" loading="lazy" <?= getFeedFallbackErrorAttr($postItem, 'mid'); ?>/>
