                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <?= loadCommonView('partials/_ad_spaces', ['adSpace' => 'posts_bottom', 'class' => 'mb-2']); ?>
                                </div>
                                    ...
                                    if ($hasMore): ?>
                                        <div class="col-12 search-load-more-container">
                                            <div class="d-flex justify-content-center mt-3 mb-3">
                                                <button class="btn-load-more-posts" data-lang-id="<?= $activeLang->id; ?>" data-type="search" data-view-type="vertical">
                                                    <span class="btn-text">
