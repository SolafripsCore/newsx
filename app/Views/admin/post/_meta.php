    ...
    <div id="seo_card_collapsible" class="collapse <?= empty($post) ? 'show' : ''; ?>">
        <div class="card-body pt-5">
            <div class="mb-6">
                ...
                <input type="text" class="form-control ai-input-title" name="meta_title" placeholder="<?= trans("meta_title", "attr"); ?>" maxlength="255" value="<?= esc(old('meta_title', $post->meta_title ?? '')); ?>">
            </div>
            <div class="mb-6">
                <label class="form-label"><?= trans("meta_description"); ?></label>
                <textarea name="meta_description" class="form-control ai-input-summary" placeholder="<?= trans("meta_description", "attr"); ?>" maxlength="500"><?= old('meta_description', $post->meta_description ?? ''); ?></textarea>
            </div>
            <div class="mb-6">
                <label class="form-label"><?= trans("meta_keywords"); ?></label>
                <input type="text" class="form-control ai-input-keywords mb-2" name="meta_keywords" placeholder="<?= trans("meta_keywords", "attr"); ?>" maxlength="255" value="<?= esc(old('meta_keywords', $post->meta_keywords ?? '')); ?>">
