...
$paywallType = in_array($settings->paywall_type, ['hard', 'preview']) ? $settings->paywall_type : 'hard';
        ...
        <div class="row g-5 g-xl-7 g-xxl-10 mb-5">
            ...
            <div class="col-lg-12 col-xl-6">
                <div class="card card-flush py-4 mb-5 mb-xl-7 mb-xxl-10">
                    ...
                    <div class="card-body pt-5">
                        <div class="mb-0">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 <?= $paywallType === 'hard' ? 'active' : ''; ?>" data-kt-button="true">
                                        <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input" type="radio" name="paywall_appearance" value="hard" <?= $paywallType === 'hard' ? 'checked' : ''; ?>/>
                                        </span>
                                        <span class="ms-5">
                                ...
                                <div class="col-12">
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 <?= $paywallType === 'preview' ? 'active' : ''; ?>" data-kt-button="true">
                                        <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input" type="radio" name="paywall_appearance" value="preview" <?= $paywallType === 'preview' ? 'checked' : ''; ?>/>
                                        </span>
                                        <span class="ms-5">
                                            <span class="fs-6 fw-bold text-gray-800 d-block"><?= trans("premium_preview_paywall"); ?></span>
                                            <span class="fs-7 text-muted fw-semibold"><?= trans("premium_preview_paywall_exp"); ?></span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="card card-flush py-4 mb-5 mb-xl-7 mb-xxl-10">
                    <div class="card-header">
                        <div class="card-title">
                            <h2><?= trans("premium_badge"); ?></h2>
                        </div>
                    </div>
                    <div class="card-body pt-5">
                        <div class="fv-row mb-0">
                            <label class="form-label"><?= trans("premium_badge_visibility"); ?></label>
                            <div class="d-flex align-items-center h-40px">
                                <?= formSwitch('premium_badge_visibility', (int)($settings->premium_badge_visibility ?? 0), trans("show")); ?>
                            </div>
                            <div class="text-muted fs-7 mt-1">
                                <?= trans("premium_badge_visibility_exp"); ?>
                            </div>
                        </div>
                    </div>
                </div>
