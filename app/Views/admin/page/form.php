...
$pageDefaultName = $page->page_default_name ?? '';

$showRightColumnOption = true;
$showContent = true;
if (!empty($page) && ($pageDefaultName == 'contact' || $pageDefaultName == 'gallery')) {
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-5">
                <div class="d-flex flex-column gap-8">
                    ...
                    <?php if (!in_array($pageDefaultName, ['become_an_author', 'gallery'], true)): ?>
                        <div class="fv-row">
                    ...
                    <?php if ($showRightColumnOption && !in_array($pageDefaultName, ['become_an_author'], true)): ?>
                        <div class="fv-row">
    ...
    <div class="d-flex flex-column flex-row-fluid gap-5 gap-xl-7 gap-xxl-10">
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-5">
                ...
                <?php if (in_array($pageDefaultName, ['become_an_author'], true)): ?>
                    <div class="mb-6 fv-row">
                        <label class="form-label"><?= trans('description'); ?></label>
                        <textarea name="description" class="form-control mb-2 ai-input-summary" placeholder="<?= trans('description', 'attr'); ?>" required><?= esc(old('description', $page->description ?? '')); ?></textarea>
                    </div>
                <?php endif; ?>
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-5">
                <div class="mb-6">
                    ...
                    <input type="text" class="form-control ai-input-title" name="meta_title" placeholder="<?= trans("meta_title", "attr"); ?>" maxlength="255" value="<?= esc(old('meta_title', $page->meta_title ?? '')); ?>">
                </div>
                <div class="mb-6">
                    <label class="form-label"><?= trans("meta_description"); ?></label>
                    <textarea name="meta_description" class="form-control ai-input-summary" placeholder="<?= trans("meta_description", "attr"); ?>" maxlength="500"><?= old('meta_description', $page->meta_description ?? ''); ?></textarea>
                </div>
                <div class="mb-6">
                    <label class="form-label"><?= trans("meta_keywords"); ?></label>
                    <input type="text" class="form-control mb-2 ai-input-keywords" name="meta_keywords" placeholder="<?= trans("meta_keywords", "attr"); ?>" maxlength="255" value="<?= esc(old('meta_keywords', $page->meta_keywords ?? '')); ?>">
