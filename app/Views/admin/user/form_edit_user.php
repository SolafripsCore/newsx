    ...
    <form action="<?= base_url('User/editUserPost'); ?>" method="post" class="kt-form" enctype="multipart/form-data">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <label class="col-lg-4 col-form-label fw-semibold fs-6"><?= trans('first_name'); ?></label>
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="first_name" value="<?= esc($user->first_name); ?>" class="form-control form-control-solid" placeholder="<?= trans('first_name', 'attr'); ?>"/>
                    </div>
                </div>

                <div class="row mb-6">
                    <label class="col-lg-4 col-form-label fw-semibold fs-6"><?= trans('last_name'); ?></label>
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="last_name" value="<?= esc($user->last_name); ?>" class="form-control form-control-solid" placeholder="<?= trans('last_name', 'attr'); ?>"/>
                    </div>
                </div>
