                        ...
                        <div class="tab-pane fade show <?= $activeTab == 'custom_code_insertion' ? 'active' : ''; ?>" id="tab_custom_code_insertion" role="tabpanel">
                            <form action="<?= adminUrl('global-settings'); ?>" method="post" class="form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="custom_header_codes" class="form-control min-h-300px" placeholder="<?= trans("custom_header_codes", "attr"); ?>"><?= esc($config->custom_header_codes); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="custom_footer_codes" class="form-control min-h-300px" placeholder="<?= trans("custom_footer_codes", "attr"); ?>"><?= esc($config->custom_footer_codes); ?></textarea>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end mt-10">
                                    <button type="submit" class="btn btn-primary" data-kt-indicator="off">
