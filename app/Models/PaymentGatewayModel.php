...
class PaymentGatewayModel extends BaseModel
{
    ...
    protected $allowedFields = ['public_key', 'secret_key', 'webhook_secret', 'environment', 'transaction_fee_rate', 'gateway_data', 'base_product_id', 'status'];
    ...
    public function updateGateway(int $id, array $postData): bool
    {
        ...
        $data = [
            ...
            'gateway_data'         => $postData['gateway_data'] ?? '',
