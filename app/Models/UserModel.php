...
class UserModel extends BaseModel
{
    ...
    protected $allowedFields = ['username', 'first_name', 'last_name', 'slug', 'email', 'email_status', 'auth_token', 'password', 'role_id', 'oauth_provider', 'oauth_uid', 'avatar',
        ...
        'balance', 'total_pageviews', 'payout_methods', 'billing_info', 'has_used_free_trial', 'reset_token', 'reset_token_created_at', 'last_login', 'last_seen',
        'author_status', 'created_at'];
