...
class SettingsModel extends BaseModel
{
    ...
    protected $allowedFields = ['lang_id', 'site_title', 'home_title', 'site_description', 'keywords', 'application_name', 'primary_font', 'secondary_font', 'content_font',
        'font_size', 'date_format', 'site_social_media', 'profile_social_media', 'optional_url_button_name', 'about_footer', 'contact_text', 'contact_address', 'contact_email',
        'contact_phone', 'invoice_details', 'copyright', 'cookies_warning', 'cookies_warning_data'];
