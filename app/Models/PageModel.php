...
class PageModel extends BaseModel
{
    ...
    protected $allowedFields = ['lang_id', 'title', 'slug', 'description', 'meta_title', 'meta_description', 'meta_keywords', 'is_custom', 'page_default_name', 'page_content', 'page_order', 'status', 'title_active', 'breadcrumb_active',
    ...
    public function addDefaultPages(int $langId): void
    {
        ...
        $pages = [
            ...
            array_merge($commonData, [
                ...
                'page_default_name' => 'become_an_author',
                'location'          => 'top',
                'description'       => 'Turn your writing expertise into a steady income. Our author reward system allows approved writers to earn money based on the traffic their articles generate.'
            ])
        ];
